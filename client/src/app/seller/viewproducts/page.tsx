      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-card-foreground">Your Products</h1>
        ...
        {products.length === 0 ? (
          ...
          <div className="bg-card rounded-3xl p-12 text-center shadow-xl border border-border backdrop-blur-sm">
            ...
            <h2 className="text-2xl font-bold text-card-foreground mb-4">No Products Yet</h2>
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              Start building your inventory by adding your first product. You can upload images, set prices, and manage your catalog.
            </p>
            <Button
              onClick={() => router.push('/seller/products/add')}
              className="bg-primary text-primary-foreground hover:bg-primary/90"
          ...
          <>
            ...
            <div className={`grid gap-6 ${
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <Card key={product.id} className={`bg-card border-border shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden ${
